...
import com.example.weighttracker.viewmodel.FoodViewModelFactory
import androidx.compose.material3.Icon
import com.example.weighttracker.ui.screens.FoodScreen
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContent {
            ...
            val stepViewModel: StepViewModel =
                viewModel(factory = stepFactory)

            val foodRepository =
                FoodRepository(database.foodDao())

            val foodFactory =
                FoodViewModelFactory(foodRepository)
            ...
            val navItems = listOf(
                ...
                NavItem("Food", Icons.Rounded.Fastfood),
